...
struct InterfaceMessage {
    ...
    virtual optional_long_long           get_file_size()         const noexcept = 0;
    virtual shared_ptr<InterfaceUser>    get_from()              const noexcept = 0;
    virtual shared_ptr<InterfaceChat>    get_chat()              const noexcept = 0;
    virtual shared_ptr<InterfaceMessage> get_reply_message()     const noexcept = 0;
