...
const_c_string HAS_MAIN_WEB_APP_KEY          = "has_main_web_app";
const_c_string ID_KEY                        = "id";
const_c_string MESSAGE_ID_KEY                = "message_id";
...
const_c_string TYPE_KEY                      = "type";
const_c_string URL_KEY                       = "url";
const_c_string USERNAME_KEY                  = "username";
const_c_string FROM_KEY                      = "from";
const_c_string CHAT_KEY                      = "chat";
