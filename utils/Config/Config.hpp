...
namespace Utils::Config {
    ...
    struct Config final : InterfaceConfig {
        ...
        int get_rabbit_mq_port() const noexcept override;
        ...
        string _db_conn_url;
        string _rabbit_mq_host = "localhost";
        int _rabbit_mq_port = 15672;
        string _rabbit_mq_vhost = "/";
        string _rabbit_mq_user = "admin";
        string _rabbit_mq_password = "qwerty";
        string _downloader_queue_name = "downloader";
        string _youtube_api_url = "http://youtube_api:8080";
