...
namespace Bot::Entity::User {
    ...
    enum UserScreen : int {
        ...
        TASK_TRACKER, ADD_TASK_DESCRIPTION, ADD_TASK_START_AT,
    ...
    const map<int, string> map_user_screen_to_string{
        {UserScreen::UNKNOWN, "UNKNOWN"},
        {UserScreen::START, "START"},
        {UserScreen::MENU, "MENU"},
        {UserScreen::DOCKER, "DOCKER"},
        {UserScreen::DICE, "DICE"},
        {UserScreen::ACCESS, "ACCESS"},
        {UserScreen::ADD_ACCESS, "ADD_ACCESS"},
        {UserScreen::WEATHER, "WEATHER"},
        {UserScreen::ADD_WEATHER_POINT, "ADD_WEATHER_POINT"},
        {UserScreen::TASK_TRACKER, "TASK_TRACKER"},
        {UserScreen::ADD_TASK_DESCRIPTION, "ADD_TASK_DESCRIPTION"},
        {UserScreen::ADD_TASK_START_AT, "ADD_TASK_START_AT"},
        {UserScreen::YOUTUBE, "YOUTUBE"},
        {UserScreen::YOUTUBE_VIDEO, "YOUTUBE_VIDEO"},
        {UserScreen::YOUTUBE_AUDIO, "YOUTUBE_AUDIO"},
        {UserScreen::YOUTUBE_PLAYLIST_VIDEO, "YOUTUBE_PLAYLIST_VIDEO"},
        {UserScreen::YOUTUBE_PLAYLIST_AUDIO, "YOUTUBE_PLAYLIST_AUDIO"},
    };
